/**
  ...
  * @author  STM32 Example
  * @brief   HAL configuration file for STM32L052
  ******************************************************************************
  * @attention
  *
...
/**
  ...
  *        stm32l0xx_hal_rcc.c needs this to report SystemCoreClock after reset,
  *        the CMSIS default of 2^21 Hz matches the MSI range 5 the RCC comes up in.
  */
